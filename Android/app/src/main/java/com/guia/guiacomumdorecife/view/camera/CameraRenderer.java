...
import com.guia.guiacomumdorecife.util.camera.BlueFilter;
import com.guia.guiacomumdorecife.util.camera.CameraFilter;
import com.guia.guiacomumdorecife.util.camera.OpenGLUtil;
...
public class CameraRenderer implements Runnable, TextureView.SurfaceTextureListener {
    ...
    public void run() {
        ...
        cameraFilterMap.append(R.id.filter7, new BlueFilter(context));
        selectedFilter = cameraFilterMap.get(R.id.filter7);
        if (selectedFilter != null)
            selectedFilter.onAttach();

        // Create texture for camera preview
        cameraTextureId = OpenGLUtil.genTexture(GLES11Ext.GL_TEXTURE_EXTERNAL_OES);
        SurfaceTexture cameraSurfaceTexture = new SurfaceTexture(cameraTextureId);
