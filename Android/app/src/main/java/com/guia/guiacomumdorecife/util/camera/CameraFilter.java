...
public abstract class CameraFilter {
    ...
    public CameraFilter(Context context) {
        ...
        if (PROGRAM == 0) {
            PROGRAM = OpenGLUtil.buildProgram(context, R.raw.vertext, R.raw.original_rtt);
        }
    }
    ...
    private void setupShaderInputs(int program, FloatBuffer vertex, FloatBuffer textureCoord, int[] iResolution, int[] iChannels, int[][] iChannelResolutions) {
        GLES20.glUseProgram(program);
